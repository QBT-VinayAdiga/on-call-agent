...
- [ ] T009 [P] Implement Braintrust tracing and telemetry initialization
- [ ] T010 [P] Setup pre-LLM secret redaction pipeline
...
- [ ] T014 [P] [US1] Eval test against golden set in tests/test_evals.py
...
- [ ] T019 [US1] Add validation and error handling (ensuring schema compliance)
- [ ] T020 [US1] Apply secret redaction to [US1] inputs
- [ ] T021 [US1] Add Braintrust spans and logging for user story 1 operations
